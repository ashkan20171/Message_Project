<%@ Page Title="" Language="C#" MasterPageFile="~/Message.Master" AutoEventWireup="true" CodeBehind="outbox.aspx.cs" Inherits="Message_Project.outbox" %>
            ...
            <div class="col-sm-9 col-md-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <asp:Repeater ID="rep_outbox" runat="server">
                            <HeaderTemplate>
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <a href="outbox.aspx?action=delete&msg_id=<%# Eval("msg_id") %>">
